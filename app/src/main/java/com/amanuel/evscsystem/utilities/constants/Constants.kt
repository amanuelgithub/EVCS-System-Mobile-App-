...
//        const val BASE_URL = "http://apix.simplifiedcoding.in/api/"
        const val BASE_AUTH_LOGIN_URL = "http://10.240.72.198:8000/sites/api/rest-auth/"
        const val BASE_AUTH_LOGOUT_URL = "http://10.240.72.198:8000/sites/api/rest-auth/"
...
//        const val BASE_URL = "http://192.168.43.212:8000/"
        const val BASE_URL = "http://10.240.72.198:8000/sites/api/"
    }
}
